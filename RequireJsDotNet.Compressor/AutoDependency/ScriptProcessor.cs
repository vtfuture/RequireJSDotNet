...
namespace RequireJsDotNet.Compressor.AutoDependency
{
    using Jint.Parser;
    using Jint.Parser.Ast;

    using RequireJsDotNet.Compressor.AutoDependency.Transformations;
    using RequireJsDotNet.Compressor.Parsing;
    using RequireJsDotNet.Compressor.Transformations;
